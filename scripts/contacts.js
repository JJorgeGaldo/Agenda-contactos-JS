...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if(addContact.classList.contains("edit")){
        ...
        // Now we update the LocalStorage
        localStorage.setItem("localContacsList", JSON.stringify(contactsList))
        return
    }
    ...
    /* First we check the LocalStorage for retrieving the existing info */
    
    if  (localStorage.getItem("localContacsList")) {
        contactsList = JSON.parse(localStorage.getItem("localContacsList"))
        putContacts()
    }else{
        fetchData()
    }
